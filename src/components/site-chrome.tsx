        ...
        <div className="flex items-center gap-2">
          ...
          {!isAuthenticated ? (
            ...
            <>
              ...
              {/* Provider icon — visible on all screen sizes */}
              {isProvider && (
                <Link
                  to="/provider"
                  aria-label="لوحة المزود"
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border/60 bg-background/60 text-muted-foreground hover:text-foreground hover:border-primary/40 hover:bg-primary/5 transition-all"
                >
